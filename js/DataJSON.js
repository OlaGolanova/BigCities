...
//Игра
const gamejson = `[
    "Метро Шанхая является первым в мире по протяжённости линий. Его длина составляет более 500 км",
    ...
    "Правительство Пекина искусственно вызывает осадки, чтобы не было пыли",
